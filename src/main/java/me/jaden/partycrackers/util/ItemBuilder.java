...
public class ItemBuilder {
    ...
    public ItemBuilder(Material material, int amount, String displayname) {
        ...
        this.amount = amount;
        this.displayname = LEGACY_COMPONENT_SERIALIZER.deserialize(displayname);
    }
     ...
     * {@link me.jaden.partycrackers.util.ItemBuilder}
     *
    ...
    public ItemBuilder lore(String line) {
        ...
        lore.add(LEGACY_COMPONENT_SERIALIZER.deserialize(line));
        return this;
    }
    ...
    public ItemBuilder lore(List<String> lore) {
        ...
        this.lore = lore.stream().map(LEGACY_COMPONENT_SERIALIZER::deserialize).collect(Collectors.toList());
        ;
        return this;
    }
    ...
    public ItemBuilder lore(String line, int index) {
        Validate.notNull(line, "The line is null.");
        lore.set(index, LEGACY_COMPONENT_SERIALIZER.deserialize(line));
        return this;
    }
